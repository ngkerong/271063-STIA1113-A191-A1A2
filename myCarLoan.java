...
public class myCarLoan {
    ...
    public static void main(String[] args){
        ...
        /*Looping*/
        if(A >= 30000.00 & B >= 0.00 & C >= 5.00 & C <= 9.00 & D >= 3.00 & D <= 7 ){
    ...
    public static void CalculateLoan(float A, float B, float C, float D ){
        ...
        String format1 = "%10s-%15s-%15s-%15s\n",
        format2 = "%40s\n%28s%.2f\n\n",
        ...
        /*Display Repayment*/
        System.out.printf(format2, "Monthly Repayment","RM",Repayment);
        
        /*Display Years, Principal, Interest, Balance*/
        System.out.printf(format1, "YEARS", "PRINCIPAL", "INTEREST", "BALANCE");
